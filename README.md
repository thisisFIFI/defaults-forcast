This repository contains my code for a course project: Forecast of Customer Defaults for LU Credit Company. How I cleaned the data, build the model and tune the parameters can be found here.
